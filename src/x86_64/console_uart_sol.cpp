...
Console_uart_sol::Regs Console_uart_sol::probe (pci_t pci)
{
    ...
    if (static_cast<uint16_t>(Pci_arch::read (pci, Pci::Cfg::Reg32::DID_VID)) == 0x8086 && Pci_arch::read (pci, Pci::Cfg::Reg32::CCP_RID) >> 8 == 0x70002) {
        ...
        regs.mem = Pci_arch::read (pci, Pci::Cfg::Reg32::BAR_1) & BIT_RANGE (31, 12);
        regs.pio = Pci_arch::read (pci, Pci::Cfg::Reg32::BAR_0) & BIT_RANGE (15, 3);

        Pci_arch::rd_wr (pci, Pci::Cfg::Reg16::CMD, !!regs.mem * BIT (1) | !!regs.pio * BIT (0));
    }
