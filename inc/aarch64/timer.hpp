...
{
    private:
        static inline constinit uint64_t offs { 0 };    // Skew between physical and system time
    ...
    public:
        static inline constinit unsigned ppi_el2_p  { Board::tmr[0].ppi };
        static inline constinit unsigned ppi_el1_v  { Board::tmr[1].ppi };
        static inline constinit bool     lvl_el2_p  { !!(Board::tmr[0].flg & BIT_RANGE (3, 2)) };
        static inline constinit bool     lvl_el1_v  { !!(Board::tmr[1].flg & BIT_RANGE (3, 2)) };
