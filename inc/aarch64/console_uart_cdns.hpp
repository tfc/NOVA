...
class Console_uart_cdns final : private Console_uart
{
    private:
        ...
        [[nodiscard]] bool tx_busy() const override final { return (read (Reg32::CSTS) & (BIT (11) | BIT (3))) != BIT (3); }
        [[nodiscard]] bool tx_full() const override final { return (read (Reg32::CSTS) &  BIT (4)); }
