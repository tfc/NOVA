...
class Console_uart_mini final : private Console_uart
{
    private:
        ...
        [[nodiscard]] bool tx_busy() const override final { return !(read (Reg32::MU_STAT) & BIT (9)); }
        [[nodiscard]] bool tx_full() const override final { return  (read (Reg32::MU_STAT) & BIT (5)); }
