...
class Vmcs final
{
    ...
    public:
        ...
        enum class Encoding : uintptr_t
        {
            ...
            GUEST_SPEC_CTRL         = 0x282e,
            GUEST_DEADLINE          = 0x2830,
        ...
        template<typename T> static inline auto read (Encoding e)
        {
            uintptr_t v;
        ...
        template<typename T> static inline void write (Encoding e, T v)
        {
        ...
        {
            // FIXME: VMCLEAR if VMCS was active
            Buddy::free (ptr);
        }
};
